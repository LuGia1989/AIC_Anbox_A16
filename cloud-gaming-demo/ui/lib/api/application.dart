...
class Application {
  static Map<String, String> appDesMap = const {
    ...
    'heroes': 'Join Heroes Evolved and compete against others from around the world.',
    'skyforce': 'Join Sky Force and shooting enemy planes and boats.  This is an old arcade game which you dont want to miss',
  };
